(function(scope) {
	...
	scope.SelectOptionsBehavior = {
		...
		observers: [
			...
			"_optionsDataSourceChanged(dataSource)",
			"_valueChanged(value)",
		 ...
		 */
		_valueCommittedCallback: function() { /* ABSTRACT */ },
		
		/**
		 * Called when the internal list of options is changed.
		 * Useful if you need to store metadata among the `SelectOptionMeta` objects.
		 */
		_optionsChangedCallback: function() { /* ABSTRACT */ },
		
		/**
		 * Called when a new request for options has been sent and it's currently loading.
		 * Used to update the UI progress indicator.
		 */
		_optionsLoadingCallback: function() { /* ABSTRACT */ },
		
		/**
		 * Called when the options have finished loading (e.g. the dataSource's AJAX request finished).
		 */
		_optionsLoadedCallback: function() { /* ABSTRACT */ },
		
		/**
		 * Called after the options were [re]filtered.
		 */
		_optionsFilteredCallback: function() { /* ABSTRACT */ },
		...
		/**
		 * Automatically fired by `CbnDataSource.ConsumberBehavior` after a new data source is set.
		 */
